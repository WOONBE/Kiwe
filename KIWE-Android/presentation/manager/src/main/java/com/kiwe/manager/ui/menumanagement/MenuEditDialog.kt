...
fun MenuEditDialog(
    ...
    onConfirm: (MenuParam) -> Unit,
    item: MenuCategoryParam,
) {
    var category: String by remember { mutableStateOf(item.category) }
    var categoryNumber: Int by remember { mutableIntStateOf(item.categoryNumber) }
    var hotOrIce: String by remember { mutableStateOf(item.hotOrIce) }
    var name: String by remember { mutableStateOf(item.name) }
    var price: Int by remember { mutableIntStateOf(item.price) }
    var description: String by remember { mutableStateOf(item.description) }
    var imgPath: String by remember { mutableStateOf(item.imgPath) }
    Dialog(
